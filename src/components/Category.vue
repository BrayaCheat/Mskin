    ...
    <section id="about" class="bg-gray-50">
        ...
        <div class="container mx-auto md:p-36 p-10 grid md:grid-cols-4 grid-cols-1 place-items-center gap-12">
            <div
                ...
                <div class="px-5 pb-5">
                    <a href="#">
                        <h5 class="text-xl font-semibold tracking-tight text-gray-900">Apple Watch Series 7
...
export default {
    data() {
        return {
            images: [
                { id: 1, src: '../assets/Images/img1.jpg', alt: 'img1', show: true, title: "1. Skin care" },
                { id: 2, src: '../assets/Images/img2.jpg', alt: 'img2', show: false, title: "2. Sunscream" },
            ]
        }
    },
    methods: {
